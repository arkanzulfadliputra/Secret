...
Section:NewButton("RickRoll Rlal", "ButtonInfo", function()
    print("Executed")
...
Section:NewButton("Firebrand", "ButtonInfo", function()
    print("Executed")
...
local entity = Creator.createEntity({
    ...
    CustomDialog = {"You died to whom you call FireBrand", "FireBrand will spawn only on your will not hide", "When you hear him spawn you only have 2 seconds to hide", "Vents do not save you aswell"}, -- Custom death message
})
...
Section:NewButton("angry munci", "ButtonInfo", function()
    print("Executed")
local Creator = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors%20Entity%20Spawner/Source.lua"))()
...
Section:NewButton("BigGames", "ButtonInfo", function()
    print("Executed")
local Creator = loadstring(game:HttpGet("https://raw.githubusercontent.com/RegularVynixu/Utilities/main/Doors%20Entity%20Spawner/Source.lua"))()
...
local entity = Creator.createEntity({
    ...
    CustomDialog = {"You Died To Big Games", "", "custom death", "message here."}, -- Custom death message
})
